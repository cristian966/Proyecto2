...
<body class="fondo">
    <div class="menu_centrado">
        <div>
            <ul>
                ...
                <li><a class="active" href="reviews_principal.php">Reviews</a></li>
    ...
    <div>
        <form action="" method="post">
            <input type="text" name="buscar" id="" placeholder="&#128269; Buscar review">
    ...
    <div class="divPadre">
        ...
        <div class="contenedor1">
            <div class="titulo">
                <h1 class="titulo1">¡Utimas 5 Reviews añadidas!</h1>
            </div>
            <!-- Agregar reviews -->
            ...
            <br>
            <div class="contenedor2">
                <img src="../img/fondoIndex.jpg" alt="imagen review 2" class="imagen">
                <div class="divcentrado">
            ...
            <br>
            <div class="contenedor2">
                <img src="../img/fondoIndex.jpg" alt="imagen review 3" class="imagen">
                <div class="divcentrado">
                    <a href=""><h1>Titulo de la review que funcionara como enlace a la pagina (plantilla que cargara los datos de la review)</h1></a>
                </div>
            </div>
            <br>
            <div class="contenedor2">
                <img src="../img/fondoIndex.jpg" alt="imagen review 4" class="imagen">
                <div class="divcentrado">
                    <a href=""><h1>Titulo de la review que funcionara como enlace a la pagina (plantilla que cargara los datos de la review)</h1></a>
                </div>
            </div>
            <br>
            <div class="contenedor2">
                <img src="../img/fondoIndex.jpg" alt="imagen review 5" class="imagen">
                <div class="divcentrado">
                    <a href=""><h1>Titulo de la review que funcionara como enlace a la pagina (plantilla que cargara los datos de la review)</h1></a>
                </div>
            </div>
